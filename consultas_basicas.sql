...
-- Utilizamos SELECT * cuando hay que explorar la tabla completa como es este primer caso, para conocer los atributos y la información de la misma. 
-- Para un análisis diario, reportes que ya tienen una estructura, no es eficiente seleccionar la tabla completa, conviene ir directo a la
